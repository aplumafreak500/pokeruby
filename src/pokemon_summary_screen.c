...
static const u8 sMoveTypeToOamPaletteNum[NUMBER_OF_MON_TYPES + CONTEST_CATEGORIES_COUNT] =
{
    ...
    [TYPE_DARK] = 5,
    [TYPE_FAIRY] = 8,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_COOL] = 5,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_BEAUTY] = 6,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_CUTE] = 6,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_SMART] = 7,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_TOUGH] = 5,
};
