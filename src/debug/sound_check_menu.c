...
#define SOUND_LIST_BGM \
	...
	X(BGM_RADIO_TOWER_OCCUPIED, "RADIO_TOWER") \
	X(MUS_OOAME, "EMR_OOAME") \
	X(MUS_B_FRONTIER, "B_FRONTIER") \
	X(MUS_B_ARENA, "B_ARENA") \
	X(MUS_ME_POINTGET, "ME_POINTGET") \
	X(MUS_ME_TORE_EYE, "ME_TORE_EYE") \
	X(MUS_PYRAMID, "PYRAMID") \
	X(MUS_PYRAMID_TOP, "PYRAMID_TOP") \
	X(MUS_B_PALACE, "B_PALACE") \
	X(MUS_REKKUU_KOURIN, "REKKUU_KOURIN") \
	X(MUS_SATTOWER, "SATTOWER") \
	X(MUS_ME_SYMBOLGET, "ME_SYMBOLGET") \
	X(MUS_B_DOME, "B_DOME") \
	X(MUS_B_TUBE, "B_TUBE") \
	X(MUS_B_FACTORY, "B_FACTORY") \
	X(MUS_VS_REKKU, "VS_REKKU") \
	X(MUS_VS_FRONT, "VS_FRONT") \
	X(MUS_VS_MEW, "VS_MEW") \
	X(MUS_B_DOME1, "B_DOME1") \
	X(MUS_RG_ANNAI, "RG_ANNAI") \
	X(MUS_RG_SLOT, "RG_SLOT") \
	X(MUS_RG_AJITO, "RG_AJITO") \
	X(MUS_RG_GYM, "RG_GYM") \
	X(MUS_RG_PURIN, "RG_PURIN") \
	X(MUS_RG_DEMO, "RG_DEMO") \
	X(MUS_RG_TITLE, "RG_TITLE") \
	X(MUS_RG_GUREN, "RG_GUREN") \
	X(MUS_RG_SHION, "RG_SHION") \
	X(MUS_RG_KAIHUKU, "RG_KAIHUKU") \
	X(MUS_RG_CYCLING, "RG_CYCLING") \
	X(MUS_RG_ROCKET, "RG_ROCKET") \
	X(MUS_RG_SHOUJO, "RG_SHOUJO") \
	X(MUS_RG_SHOUNEN, "RG_SHOUNEN") \
	X(MUS_RG_DENDOU, "RG_DENDOU") \
	X(MUS_RG_T_MORI, "RG_T_MORI") \
	X(MUS_RG_OTSUKIMI, "RG_OTSUKIMI") \
	X(MUS_RG_POKEYASHI, "RG_POKEYASHI") \
	X(MUS_RG_ENDING, "RG_ENDING") \
	X(MUS_RG_LOAD01, "RG_LOAD01") \
	X(MUS_RG_OPENING, "RG_OPENING") \
	X(MUS_RG_LOAD02, "RG_LOAD02") \
	X(MUS_RG_LOAD03, "RG_LOAD03") \
	X(MUS_RG_CHAMP_R, "RG_CHAMP_R") \
	X(MUS_RG_VS_GYM, "RS_VS_GYM") \
	X(MUS_RG_VS_TORE, "RG_VS_GYM") \
	X(MUS_RG_VS_YASEI, "VS_YASEI") \
	X(MUS_RG_VS_LAST, "RG_VS_LAST") \
	X(MUS_RG_MASARA, "RG_MASARA") \
	X(MUS_RG_KENKYU, "RG_KENKYU") \
	X(MUS_RG_OHKIDO, "RG_OHKIDO") \
	X(MUS_RG_POKECEN, "RG_POKECEN") \
	X(MUS_RG_SANTOAN, "RG_SANTOAN") \
	X(MUS_RG_NAMINORI, "RG_NAMINORI") \
	X(MUS_RG_P_TOWER, "RG_P_TOWER") \
	X(MUS_RG_SHIRUHU, "RG_SHIRUHU") \
	X(MUS_RG_HANADA, "HANADA") \
	X(MUS_RG_TAMAMUSI, "RG_TAMAMUSI") \
	X(MUS_RG_WIN_TRE, "RG_WIN_TRE") \
	X(MUS_RG_WIN_YASEI, "RG_WIN_YASEI") \
	X(MUS_RG_WIN_GYM, "RG_WIN_GYM") \
	X(MUS_RG_KUCHIBA, "RG_KUCHIBA") \
	X(MUS_RG_NIBI, "RG_NIBI") \
	X(MUS_RG_RIVAL1, "RG_RIVAL1") \
	X(MUS_RG_RIVAL2, "RG_RIVAL2") \
	X(MUS_RG_FAN2, "RG_FAN2") \
	X(MUS_RG_FAN5, "RG_FAN5") \
	X(MUS_RG_FAN6, "RG_FAN6") \
	X(MUS_ME_RG_PHOTO, "ME_RG_PHOTO") \
	X(MUS_RG_TITLEROG, "RG_TITLEROG") \
	X(MUS_RG_GET_YASEI, "RG_GET_YASEI") \
	X(MUS_RG_SOUSA, "RG_SOUSA") \
	X(MUS_RG_SEKAIKAN, "RG_SEKAIKAN") \
	X(MUS_RG_SEIBETU, "RG_SEIBETU") \
	X(MUS_RG_JUMP, "RG_JUMP") \
	X(MUS_RG_UNION, "RG_UNION") \
	X(MUS_RG_NETWORK, "RG_NETWORK") \
	X(MUS_RG_OKURIMONO, "RG_OKURIMONO") \
	X(MUS_RG_KINOMIKUI, "RG_KINOMIKUI") \
	X(MUS_RG_NANADUNGEON, "RG_NANADUNGEON") \
	X(MUS_RG_OSHIE_TV, "RG_OSHIE_TV") \
	X(MUS_RG_NANASHIMA, "RG_NANASHIMA") \
	X(MUS_RG_NANAISEKI, "RG_NANAISEKI") \
	X(MUS_RG_NANA123, "RG_NANA123") \
	X(MUS_RG_NANA45, "RG_NANA45") \
	X(MUS_RG_NANA67, "RG_NANA67") \
	X(MUS_RG_POKEFUE, "RG_POKEFUE") \
	X(MUS_RG_VS_DEO, "RG_VS_DEO") \
	X(MUS_RG_VS_MYU2, "RG_VS_MYU2") \ 
	X(MUS_RG_VS_DEN, "RG_VS_DEN") \
	X(MUS_RG_EXEYE, "RG_EXEUE") \
	X(MUS_RG_DEOEYE, "RG_DEOEYE") \
	X(MUS_RG_T_TOWER, "RG_T_TOWER") \
	X(MUS_RG_SLOWMASARA, "RG_SLOWMASARA") \
	X(MUS_RG_TVNOIZE, "RG_TVNOIZE") \
...
#define SOUND_LIST_SE \
	...
	X(SE_W114, "W114") \
	X(SE_W063B, "W063B") \
	X(SE_RG_W_DOOR, "RG_W_DOOR") \
	X(SE_RG_CARD1, "RG_CARD1") \
	X(SE_RG_CARD2, "RG_CARD2") \
	X(SE_RG_CARD3, "RG_CARD3") \
	X(SE_RG_BAG1, "RG_BAG1") \
	X(SE_RG_BAG2, "RG_BAG2") \
	X(SE_RG_GETTING, "RG_GETTING") \
	X(SE_RG_SHOP, "RG_SHOP") \
	X(SE_RG_KITEKI, "RG_KITEKI") \
	X(SE_RG_HELP_OP, "RG_HELP_CL") \
	X(SE_RG_HELP_CL, "RG_HELP_CL") \
	X(SE_RG_HELP_NGM, "RG_HELP_NGM") \
	X(SE_RG_DEOMOV, "RG_DEOMOV") \
	X(SE_RG_EXCELLENT, "RG_EXCELLENT") \
	X(SE_RG_NAWAMISS, "RG_NAWAMISS") \
