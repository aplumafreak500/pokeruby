...
IWRAM_DATA u8 gSpriteOrder[MAX_SPRITES] = {0};
IWRAM_DATA bool8 gShouldProcessSpriteCopyRequests = 0;
IWRAM_DATA u8 gSpriteCopyRequestCount = 0;
IWRAM_DATA struct SpriteCopyRequest gSpriteCopyRequests[MAX_SPRITE_COPY_REQUESTS] = {0};
IWRAM_DATA u8 gOamLimit = 0;
IWRAM_DATA u16 gReservedSpriteTileCount = 0;
IWRAM_DATA u8 gSpriteTileAllocBitmap[128] = {0};
IWRAM_DATA s16 gSpriteCoordOffsetX = 0;
IWRAM_DATA s16 gSpriteCoordOffsetY = 0;
IWRAM_DATA u32 gOamMatrixAllocBitmap = 0;
IWRAM_DATA struct OamMatrix gOamMatrices[OAM_MATRIX_COUNT] = {0};
IWRAM_DATA u8 gReservedSpritePaletteCount = 0;
