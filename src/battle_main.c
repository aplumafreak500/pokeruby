...
EWRAM_DATA u16 gSideStatuses[3];
...
// We have to leave these two alone for now. Damm you GF and your memory fuckery!
...
EWRAM_DATA struct BattleEnigmaBerry gEnigmaBerries[4];
...
void debug_sub_8012AC0(s8 a, u8 taskId)
{
    do
    {
        gCurrentMove += a;
        if (gCurrentMove == 0)
            gCurrentMove = NUM_SPECIES;
        if (gCurrentMove == NUM_SPECIES)
            gCurrentMove = 1;
...
void debug_sub_8012D10(u8 taskId)
{
    ...
    case 1:
        ...
        else if (gMain.newAndRepeatedKeys & R_BUTTON)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                if (gCurrentMove + 10 < NUM_SPECIES)
                    gCurrentMove += 10;
                else
                    gCurrentMove -= NUM_SPECIES - 10;
                debug_sub_80128B4();
                debug_sub_8012938(taskId);
                debug_sub_80129F8(taskId);
                break;
    ...
    case 3:
        ...
        else if (gMain.newKeys & A_BUTTON)
        {
            ...
            if (gTasks[taskId].data[3] == 0)
                debug_sub_80132C8(31, gUnknown_Debug_2023B62, NUM_SPECIES);
            debug_sub_8012B70(taskId, 1);
        }
        else if (gMain.newKeys & B_BUTTON)
        {
    ...
    case 4:
        ...
        else if (gMain.newKeys & A_BUTTON)
        {
            PlaySE(SE_SELECT);
            if (gTasks[taskId].data[3] == 0)
                debug_sub_8013294(31, gUnknown_Debug_2023B62, NUM_SPECIES);
            debug_sub_8012B70(taskId, 1);
        }
        else if (gMain.newKeys & B_BUTTON)
        {
