...
const u16 gVictiniLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND), // Searing Shot
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 1, MOVE_EMBER), // Incenerate
    LEVEL_UP_MOVE( 1, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 9, MOVE_ENDURE),
    LEVEL_UP_MOVE(17, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(25, MOVE_FIRE_SPIN), // Flame Charge
    LEVEL_UP_MOVE(33, MOVE_REVERSAL),
    LEVEL_UP_MOVE(41, MOVE_SUNNY_DAY), // Flame Burst
    LEVEL_UP_MOVE(49, MOVE_EXTRASENSORY), // Zen Headbutt
    LEVEL_UP_MOVE(57, MOVE_FIRE_BLAST), // Inferno
    LEVEL_UP_MOVE(65, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(73, MOVE_PSYCHIC), // Flare Blitz
    LEVEL_UP_MOVE(81, MOVE_SEISMIC_TOSS), // Final Gambit
    LEVEL_UP_MOVE(89, MOVE_PSYCHO_BOOST), // Stored Power
