...
ALL_BUILDS := ruby ruby_rev1 ruby_rev2 sapphire sapphire_rev1 sapphire_rev2 ruby_de sapphire_de ruby_de_debug sapphire_de_debug ruby_debug sapphire_debug ruby_rev1_debug ruby_rev2_debug sapphire_rev1_debug sapphire_rev2_debug
...
sapphire_de_debug: ; @$(MAKE) GAME_VERSION=SAPPHIRE GAME_LANGUAGE=GERMAN DEBUG=1 COMPARE=0
ruby_debug: ; @$(MAKE) GAME_VERSION=RUBY DEBUG=1 COMPARE=0
...
sapphire_debug: ; @$(MAKE) GAME_VERSION=SAPPHIRE DEBUG=1 COMPARE=0
