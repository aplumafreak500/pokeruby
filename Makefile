...
ruby:          ; @$(MAKE) GAME_VERSION=RUBY DEBUG_TRANSLATE=1
ruby_rev1:     ; @$(MAKE) GAME_VERSION=RUBY GAME_REVISION=1 DEBUG_TRANSLATE=1
ruby_rev2:     ; @$(MAKE) GAME_VERSION=RUBY GAME_REVISION=2 DEBUG_TRANSLATE=1
sapphire:      ; @$(MAKE) GAME_VERSION=SAPPHIRE DEBUG_TRANSLATE=1
sapphire_rev1: ; @$(MAKE) GAME_VERSION=SAPPHIRE GAME_REVISION=1 DEBUG_TRANSLATE=1
sapphire_rev2: ; @$(MAKE) GAME_VERSION=SAPPHIRE GAME_REVISION=2 DEBUG_TRANSLATE=1
ruby_de:       ; @$(MAKE) GAME_VERSION=RUBY GAME_LANGUAGE=GERMAN DEBUG_TRANSLATE=1
sapphire_de:   ; @$(MAKE) GAME_VERSION=SAPPHIRE GAME_LANGUAGE=GERMAN DEBUG_TRANSLATE=1
ruby_debug:          ; @$(MAKE) GAME_VERSION=RUBY DEBUG=1 DEBUG_TRANSLATE=1
ruby_rev1_debug:     ; @$(MAKE) GAME_VERSION=RUBY GAME_REVISION=1 DEBUG=1 DEBUG_TRANSLATE=1
ruby_rev2_debug:     ; @$(MAKE) GAME_VERSION=RUBY GAME_REVISION=2 DEBUG=1 DEBUG_TRANSLATE=1
sapphire_debug:      ; @$(MAKE) GAME_VERSION=SAPPHIRE DEBUG=1 DEBUG_TRANSLATE=1
sapphire_rev1_debug: ; @$(MAKE) GAME_VERSION=SAPPHIRE GAME_REVISION=1 DEBUG=1 DEBUG_TRANSLATE=1
sapphire_rev2_debug: ; @$(MAKE) GAME_VERSION=SAPPHIRE GAME_REVISION=2 DEBUG=1 DEBUG_TRANSLATE=1
ruby_de_debug:       ; @$(MAKE) GAME_VERSION=RUBY GAME_LANGUAGE=GERMAN DEBUG=1 DEBUG_TRANSLATE=1
sapphire_de_debug:   ; @$(MAKE) GAME_VERSION=SAPPHIRE GAME_LANGUAGE=GERMAN DEBUG=1 DEBUG_TRANSLATE=1
ruby_eur:       ; @$(MAKE) GAME_VERSION=RUBY GAME_LANGUAGE=PAL DEBUG_TRANSLATE=1
sapphire_eur:   ; @$(MAKE) GAME_VERSION=SAPPHIRE GAME_LANGUAGE=PAL DEBUG_TRANSLATE=1
ruby_eur_debug:       ; @$(MAKE) GAME_VERSION=RUBY GAME_LANGUAGE=PAL DEBUG=1 DEBUG_TRANSLATE=1
sapphire_eur_debug:   ; @$(MAKE) GAME_VERSION=SAPPHIRE GAME_LANGUAGE=PAL DEBUG=1 DEBUG_TRANSLATE=1
