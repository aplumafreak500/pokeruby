...
// Emerald music below
#define MUS_OOAME 468           // The Flood
#define MUS_B_FRONTIER 469      // Battle Frontier
#define MUS_B_ARENA 470         // Battle Arena
#define MUS_ME_POINTGET 471     // Obtained Battle Points!
#define MUS_ME_TORE_EYE 472     // Registered Trainer!
#define MUS_PYRAMID 473         // Battle Pyramid
#define MUS_PYRAMID_TOP 474     // Top of the Battle Pyramid
#define MUS_B_PALACE 475        // Battle Palace
#define MUS_REKKUU_KOURIN 476   // Rayquaza Enters
#define MUS_SATTOWER 477        // Battle Tower (Emerald)
#define MUS_ME_SYMBOLGET 478    // Obtained a Frontier Symbol!
#define MUS_B_DOME 479          // Battle Dome
#define MUS_B_TUBE 480          // Battle Pike
#define MUS_B_FACTORY 481       // Battle Factory
#define MUS_VS_REKKU 482        // Battle! Legendary Pokémon
#define MUS_VS_FRONT 483        // Battle! Frontier Brain
#define MUS_VS_MEW 484          // Battle! Mew
#define MUS_B_DOME1 485         // Battle Dome Lobby
// FRLG Music Below
#define MUS_RG_ANNAI 486        // Follow Me!
#define MUS_RG_SLOT 487         // Game Corner
#define MUS_RG_AJITO 488        // Rocket Hideout
#define MUS_RG_GYM 489          // Gym
#define MUS_RG_PURIN 490        // Jigglypuff's Song
#define MUS_RG_DEMO 491         // Opening Movie
#define MUS_RG_TITLE 492        // Title Screen
#define MUS_RG_GUREN 493        // Cinnabar Island
#define MUS_RG_SHION 494        // Lavender Town
#define MUS_RG_KAIHUKU 495      // RBY Pokémon Center Healing
#define MUS_RG_CYCLING 496      // Cycling
#define MUS_RG_ROCKET 497       // Encounter! Team Rocket
#define MUS_RG_SHOUJO 498       // Encounter! Girl
#define MUS_RG_SHOUNEN 499      // Encounter! Boy
#define MUS_RG_DENDOU 500       // You're the Champion!
#define MUS_RG_T_MORI 501       // Viridian Forest
#define MUS_RG_OTSUKIMI 502     // Mt. Moon
#define MUS_RG_POKEYASHI 503    // Pokémon Mansion
#define MUS_RG_ENDING 504       // Credits
#define MUS_RG_LOAD01 505       // Route 1
#define MUS_RG_OPENING 506      // Route 24/Intro
#define MUS_RG_LOAD02 507       // Route 3
#define MUS_RG_LOAD03 508       // Route 11
#define MUS_RG_CHAMP_R 509      // Victory Road/Indigo Plateau
#define MUS_RG_VS_GYM 510       // Battle! Gym Leader/Elite Four
#define MUS_RG_VS_TORE 511      // Battle! Trainer
#define MUS_RG_VS_YASEI 512     // Battle! Wild Pokémon
#define MUS_RG_VS_LAST 513      // Battle! Champion
#define MUS_RG_MASARA 514       // Pallet Town
#define MUS_RG_KENKYU 515       // Professor Oak's Lab
#define MUS_RG_OHKIDO 516       // Professor Oak's Theme
#define MUS_RG_POKECEN 517      // Pokémon Center
#define MUS_RG_SANTOAN 518      // S.S. Anne
#define MUS_RG_NAMINORI 519     // Surfing
#define MUS_RG_P_TOWER 520      // Pokémon Tower
#define MUS_RG_SHIRUHU 521      // Silph Co.
#define MUS_RG_HANADA 522       // Cerulean/Fuschia City
#define MUS_RG_TAMAMUSI 523     // Celadon City
#define MUS_RG_WIN_TRE 524      // Victory! Trainer
#define MUS_RG_WIN_YASEI 525    // Victory! Wild Pokémon
#define MUS_RG_WIN_GYM 526      // Victory! Gym Leader
#define MUS_RG_KUCHIBA 527      // Vermillion City
#define MUS_RG_NIBI 528         // Viridian/Saffron/Pewter City
#define MUS_RG_RIVAL1 529       // Encounter! Rival
#define MUS_RG_RIVAL2 530       // Rival's Exit
#define MUS_RG_FAN2 531         // Fanfare 2
#define MUS_RG_FAN5 532         // Obtained a Starter!
#define MUS_RG_FAN6 533         // Pokémon Caught! (Used in Emerald)
#define MUS_ME_RG_PHOTO 534     // Trainer Photo
#define MUS_RG_TITLEROG 535     // Game Freak
#define MUS_RG_GET_YASEI 536    // Pokémon Caught Victory Theme
#define MUS_RG_SOUSA 537        // Starting Tutorial
#define MUS_RG_SEKAIKAN 538     // Starting Tutorial 2
#define MUS_RG_SEIBETU 539      // Starting Tutorial 3
#define MUS_RG_JUMP 540         // Jumping Minigame
#define MUS_RG_UNION 541        // Union Room
#define MUS_RG_NETWORK 542      // Network Center
#define MUS_RG_OKURIMONO 543    // Mystery Gift
#define MUS_RG_KINOMIKUI 544
#define MUS_RG_NANADUNGEON 545  // Sevii Caves/Altering Cave (Mt. Moon)
#define MUS_RG_OSHIE_TV 546     // Follow Me!
#define MUS_RG_NANASHIMA 547    // Sevii Islands Routes (Lake of Rage)
#define MUS_RG_NANAISEKI 548    // Sevii Forests (Viridian Forest)
#define MUS_RG_NANA123 549      // Sevii Islands 1-3 (Viridian/Saffron/Pewter)
#define MUS_RG_NANA45 550       // Sevii Islands 4-5 (Azalea Town)
#define MUS_RG_NANA67 551       // Sevii Islands 6-7 (Violet City)
#define MUS_RG_POKEFUE 552      // Poké Flute
#define MUS_RG_VS_DEO 553       // Battle! Deoxys
#define MUS_RG_VS_MYU2 554      // Battle! Mewtwo
#define MUS_RG_VS_DEN 555       // Battle! Legendary Birds
#define MUS_RG_EXEYE 556        // Encounter! Gym Leader
#define MUS_RG_DEOEYE 557       // Encounter! Deoxys
#define MUS_RG_T_TOWER 558      // Trainer Tower (Gym)
#define MUS_RG_SLOWMASARA 559   // Pallet Town (Hall of Fame remix)
#define MUS_RG_TVNOIZE 560      // Teachy TV

// End FR/LG songs. Unknown sounds used below in Emerald.
